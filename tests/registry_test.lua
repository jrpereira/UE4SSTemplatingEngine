...
check(table.concat(categories:list(), ',') == 'npc,npc.intent,npc.level,npc.melee,npc.pawn,other,other.unknown,player,player.charges,player.compass,player.notifications,player.quickslots,player.self,player.stats,player.wheel')
check(categories:contains('player') and categories:contains('npc'))
check(type(categories._categories.player.quickslots) == 'table')
check(type(categories._categories.npc.intent) == 'table')
check(type(categories._categories.other.unknown) == 'table')
check(V.template({collection='Tests',name='Other',category='other'}, categories, 'other.lua').category == 'other')
