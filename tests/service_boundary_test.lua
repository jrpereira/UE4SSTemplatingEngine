...
local function template(name)
    return {name=name,category='player.quickslots',
...
local attackTemplate={name='Attacks',category='npc.attacks',settings={target='templates',enabled=true},subscribe={{path=class,
