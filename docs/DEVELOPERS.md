...
The Action Fandango Wheels template owns its Swap and Distant styles, settings, wheel separation, and restoration. ModCoreTemplates discovers the declared target and invokes the template lifecycle. ModCoreControls owns input independently.
